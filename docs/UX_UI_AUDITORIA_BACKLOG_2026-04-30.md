...
- **Status 2026-05-02:** rodapé sticky adicionado para touch/tablet com contexto do exercício atual, progresso, `Anterior`, `Próximo`, `Salvar` e acesso a `Voltar`, mantendo desktop sem sticky.
- **Effort:** L
