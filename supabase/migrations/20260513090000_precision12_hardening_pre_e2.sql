...
-- NOTA: comentários como string literal única (sem `||`).
-- O runner do Lovable processa COMMENT ON via prepared statement onde
-- `||` é interpretado pelo client antes de chegar no Postgres, causando
-- `syntax error at or near "||"`. Strings literais únicas evitam isso.
